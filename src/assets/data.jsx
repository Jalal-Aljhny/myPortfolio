...
export const portfolio = [
  {
    id: -1,
    title: "Full-featured e-commerce platform (laravel api)",
    details: {
      technologies: [
        "material ui",
        "axios",
      ...
      viewProject: "",
      viewCode: "https://github.com/Jalal-Aljhny/e-commerce",
      userStory: `
    ...
    <li>Robust validation and error handling.</li>
    <li>Centralized state management via React Context.</li>
    <li>Reviews and one level comments system.</li>
    <li>Pagination on data (orders, products, comments).</li>
    <li>Skeleton loading on content.</li>
      `,
    },
  },
  {
